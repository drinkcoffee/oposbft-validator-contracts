...
contract Validators is ValidatorSmartContractInterface {
    ...
    constructor (address[] memory _validatorOwners, address[] memory _validators) {
        if (_validatorOwners,length)
